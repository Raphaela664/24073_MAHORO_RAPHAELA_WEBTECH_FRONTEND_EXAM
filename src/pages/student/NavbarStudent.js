  ...
  return (
    <nav className="flex items-center justify-between gradient  p-4 z-40">
        ...
        >
          <li className="y-6 xl:my-0 ml-2 mr-4 my-6">
            <Link
              ...
              className={`my-6 xl:my-0 ml-2 no-underline text-white mr-4 ${
                location.pathname === "/student/dashboard" ? "border-b-2 pb-2" : ""
              }`}
          ...
          <li className="y-6 xl:my-0 ml-4 my-8 ">
            <Link
              ...
              className={`my-6 xl:my-0  no-underline text-white mr-4 ${
                location.pathname === "/student/submission" ? "border-b-2 pb-2" : ""
              }`}
              onClick={() => setIsMenuOpen(false)}
            >
              Submission
      ...
      <div className="flex items-center space-x-4 ml-3">
        ...
        <h3 className="hidden xl:block  text-white">{userEmail}</h3>
        <img
